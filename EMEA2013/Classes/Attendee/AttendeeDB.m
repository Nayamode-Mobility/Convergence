...
- (BOOL)AddMyExhibitor:(AttendeeExhibitor*)objAttendeeExhibitor isSynced:(BOOL)isSynced
{
    ...
    NSString *strSQL = @"Insert Into AttendeeExhibitors(ExhibitorID, IsDeleted, IsSynced) ";
...
- (NSArray*)GetAttendeesCategoryOfFilterType:(NSString*)strFilterType
{
    ...
    char *strSQL = "SELECT ParentFilter,FilterName FROM FindlIkeMindedFilter where FilterType = ''";
