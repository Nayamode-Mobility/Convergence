...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i < [arrShuttleInfo count]; i++)
    {
        ...
        if(objShuttleInfo.Phone1 != (id)[NSNull null])
        {
            ...
            UILabel * lblPhone=[[UILabel alloc]initWithFrame:CGRectMake(100, 15, 150, 30)];
            // lblPhone.text=@"67677878";
            lblPhone.text=((shuttleInfo*)[arrShuttleInfo objectAtIndex:i]).Phone1;
            
            
            UILabel * lblPhoneText=[[UILabel alloc]initWithFrame:CGRectMake(100, lblPhone.frame.origin.y+lblPhone.frame.size.height+3,150, 30)];
        ...
        if(objShuttleInfo.Phone2 != (id)[NSNull null])
        {
            ...
            UILabel * lblPhoneText2=[[UILabel alloc]initWithFrame:CGRectMake(100, lblPhone2.frame.origin.y+lblPhone2.frame.size.height+3,150, 30)];
        ...
        if(objShuttleInfo.Phone3 != (id)[NSNull null])
        {
            ...
            phone3ImgView.image=[UIImage imageNamed:@"ExpoMap.png"];
            
            UILabel * lblPhone3=[[UILabel alloc]initWithFrame:CGRectMake(100, 15, 150, 30)];
            
            lblPhone3.text=((shuttleInfo*)[arrShuttleInfo objectAtIndex:i]).Phone3;
            
            //  lblPhone3.text=@"67677878";
            
            UILabel * lblPhoneText3=[[UILabel alloc]initWithFrame:CGRectMake(100, lblPhone3.frame.origin.y+lblPhone3.frame.size.height+3,150, 30)];
        ...
        if(objShuttleInfo.Email1 != (id)[NSNull null])
        {
            ...
            emailImgView.image=[UIImage imageNamed:@"ExpoMap.png"];
            
            UILabel * lblemail1Text=[[UILabel alloc]initWithFrame:CGRectMake(100, 15, 150, 30)];
            
            lblemail1Text.text=((shuttleInfo*)[arrShuttleInfo objectAtIndex:i]).Email1Text;
            
            //  lblemail1Text.text=@"Test Mail";
            
            UILabel * lblEmail1=[[UILabel alloc]initWithFrame:CGRectMake(100, lblemail1Text.frame.origin.y+lblemail1Text.frame.size.height+3,150, 30)];
