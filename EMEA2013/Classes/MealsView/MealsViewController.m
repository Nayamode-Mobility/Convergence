...
- (void)viewDidLoad
{
    ...
    [Analytics AddAnalyticsForScreen:strSCREEN_MEALS];
}
...
-(void)populateData:(NSUInteger)index{
    ...
    if ([DeviceManager IsiPhone])
    {
        ...
        for(EventInfoDetails *objDetail in objEventCat.arrEventInfoDetails)
        {
            ...
            NSString *strData = [NSString stringWithFormat:@"<font style='color: #68217A; font-size:15; font-family: SegoeWP-Bold'>%@</font><br><font style='color: #000000; font-size:13; font-family: SegoeWP'>%@</font>",objDetail.strTitle,objDetail.strBriefDescription];
            ...
            UIFont *ftDescription=[UIFont fontWithName:@"SegoeWP" size:13.0];
            CGSize expectedLabelSizeForDescription = [objDetail.strBriefDescription sizeWithFont:ftDescription
                                                                               constrainedToSize:CGSizeMake(intWidth,1000)
                                                                                   lineBreakMode:NSLineBreakByWordWrapping];
            
            UIWebView *vwWeb = [[UIWebView alloc] initWithFrame:CGRectMake(20, intY, intWidth, (expectedLabelSizeForTitle.height + expectedLabelSizeForDescription.height + 100 ))];
            ...
            intY = intY + (expectedLabelSizeForTitle.height + expectedLabelSizeForDescription.height + 40);
        }
        detailView.tag = 1;
