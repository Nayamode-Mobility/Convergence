...
- (NSArray*)GetTimeslot
{
	...
	NSMutableArray *arrTimeSlot = [[NSMutableArray alloc] init];
    
	dbEMEAFY14 = [[DB GetInstance] OpenDatabase];
    
    char *strSQL = "Select SessionInstanceID, StartTime, EndTime From Sessions Order By SessionInstanceID";
	...
	if (outval == SQLITE_OK)
    {
        ...
        [arrTimeSlot addObject:objFilters];
