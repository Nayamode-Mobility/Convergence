...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (tableView.tag)
    {
        ...
        case 5:
        {
            Speaker *objspeaker = [self.arrIndustries objectAtIndex:indexPath.row];
            self.lblSpeakerID.text = objspeaker.strFirstName;
            
            MasterDB *objMasterDB = [MasterDB GetInstance];
            self.lblSpeakerID.text = [objMasterDB GetIndustryID:self.lblSpeakerID.text];
